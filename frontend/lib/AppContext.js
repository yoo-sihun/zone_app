...
export function AppProvider({ children }) {
  ...
  const saveProduct = useCallback(async (name, ingredients, editId, category, image) => {
    const body = JSON.stringify({ name, ingredients, category: category || null, image: image || null });
    const r = editId
